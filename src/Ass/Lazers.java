...
public class Lazers {
	...
	{
        bullet = new Sphere(12,24);
        bullet.setTexture("Textures/star03.bmp");
        bullet.scale(0.2f,0.2f,0.5f);
	...
	{
		position.add(Vector3D.scale(n,-speed * deltaTime));
	}
...
//		Gdx.gl11.glTexCoordPointer(2, GL11.GL_FLOAT, 0, texCoordBuffer);
		...
		Gdx.gl11.glTranslatef(1.9f, 0, 0);
		//Gdx.gl11.glDrawArrays(GL11.GL_TRIANGLE_STRIP, 0, 4);
        bullet.draw();
		Gdx.gl11.glTranslatef(-3.9f, 0, 0);
		//Gdx.gl11.glDrawArrays(GL11.GL_TRIANGLE_STRIP, 0, 4);
        Gdx.gl11.glRotatef(180,0.0f,0.0f,1.0f);
        bullet.draw();
